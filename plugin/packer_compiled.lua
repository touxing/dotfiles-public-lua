...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "vim-dadbod-completion", "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-spell", "cmp-vsnip", "friendly-snippets" },
  ...
  ["nvim-lsp-installer"] = {
    after = { "lspsaga.nvim", "nvim-lint", "nvim-lightbulb", "fidget.nvim" },
  ...
  ["nvim-web-devicons"] = {
    after = { "bufferline.nvim", "nvim-tree.lua", "lualine.nvim", "aerial.nvim" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "C:\\Users\\cenqw\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\nvim-web-devicons",
  ...
  ["spellsitter.nvim"] = {
    config = { "require('conf/spellsitter')" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["switch.vim"] = {
    config = { "require('conf/switch')" },
    loaded = false,
    needs_bufread = true,
    only_cond = false,
    path = "C:\\Users\\cenqw\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\switch.vim",
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'lsp-colors.nvim', 'vimcdoc', 'lsp_signature.nvim', 'nvim-dap', 'nvim-scrollbar', 'nvim-colorizer.lua', 'nvim-lastplace', 'bufdelete.nvim', 'nvim-treesitter', 'plenary.nvim', 'vim-illuminate', 'nvim-hlslens', 'ripgrep', 'nvim-ts-context-commentstring', 'nvim-ts-rainbow', 'spellsitter.nvim', 'surround.nvim', 'switch.vim', 'nvim-lspconfig', 'which-key.nvim', 'nvim-notify', 'undotree', 'fd', 'todo-comments.nvim', 'toggleterm.nvim', 'indent-blankline.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au InsertCharPre * ++once lua require("packer.load")({'copilot.vim'}, { event = "InsertCharPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'nvim-autopairs', 'lspkind-nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp-colors.nvim', 'vimcdoc', 'lsp_signature.nvim', 'nvim-dap', 'nvim-scrollbar', 'nvim-colorizer.lua', 'nvim-lastplace', 'bufdelete.nvim', 'nvim-treesitter', 'plenary.nvim', 'vim-illuminate', 'nvim-hlslens', 'ripgrep', 'nvim-ts-context-commentstring', 'nvim-ts-rainbow', 'spellsitter.nvim', 'surround.nvim', 'switch.vim', 'nvim-lspconfig', 'which-key.nvim', 'nvim-notify', 'undotree', 'fd', 'todo-comments.nvim', 'toggleterm.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
